...
VertexType fromString(const std::string& type) {
    if (type == "ROOT" || type == "ROOT-USER")
        return VertexType::ROOT;
    else if (type == "CATEGORY" || type == "TRUNC-CATEGORY")
        return VertexType::CATEGORY;
    else if (type == "SKILL" || type == "BRANCH-SKILL")
        return VertexType::SKILL;
    else if (type == "LEVEL" || type == "LEAF-LEVEL")
        return VertexType::LEVEL;
